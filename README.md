# Ubill Upayment Uplatform

## Project Overview
This repository showcases QA/SDET work on a sample **Bill Payments & Utility Recharge** application. It is a portfolio project built with dummy/sample data only — no real client names, production data, or confidential information are included.
...
Cypress, JavaScript, Postman, Git, JIRA
